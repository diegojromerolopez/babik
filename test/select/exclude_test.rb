...
class ExcludeTest < Minitest::Test
  def setup
    ...
    User.create!(first_name: 'Favila', biography: 'Short reign of two years, seven months and ten days',
                 zone: @cangas_de_onis)
    User.create!(first_name: 'Alfonso I', last_name: 'El Católico', biography: 'Son-in-law of Don Pelayo',
                 zone: @cantabria)
    User.create!(first_name: 'Fruela I', last_name: 'Hombre de Hierro', biography: 'Killed by conspirators',
                 zone: @cangas_de_onis)
    ...
    User.create!(first_name: 'Alfonso II', last_name: 'El Casto', biography: 'Discovered Saint James tomb',
                 zone: @oviedo)
    User.create!(first_name: 'Mauregato', biography: 'Paid the 100 maidens tribute to Cordova Emirate', zone: @asturias)
    User.create!(first_name: 'Bermudo I', last_name: 'El Diácono',
                 biography: 'Cultured, magnanimous and illustrated man')
    ...
    User.create!(first_name: 'Alfonso III', last_name: 'El Magno',
                 biography: 'Last king of Independent Asturian kingdom')
  ...
  def test_local_exclude
    ...
    asturian_kings = %w[Aurelio Favila Mauregato Pelayo Silo]
